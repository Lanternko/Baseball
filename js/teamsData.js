...
export const ALL_TEAMS = [
  // ──────────────  NEW YORK YANKEES  ──────────────
  {
    ...
    name: "Yankees",
    batters: [
      { name: "Trent Grisham",     pos: "CF", type: "batter", stats: { power: 8, hitRate: 6, contact: 6, speed: 8 } }, // 1
      ...
      { name: "Ben Rice",          pos: "DH", type: "batter", stats: { power: 8, hitRate: 7, contact: 6, speed: 5 } }, // 5
  ...
  // ──────────────  LOS ANGELES DODGERS  ──────────────
  {
    ...
    name: "Dodgers",
    batters: [
      { name: "Shohei Ohtani",     pos: "DH", type: "batter", stats: { power: 10, hitRate: 9, contact: 8, speed: 8 } }, // 2
      { name: "Mookie Betts",      pos: "SS", type: "batter", stats: { power: 7, hitRate: 9, contact: 8, speed: 9 } }, // 1
      ...
      { name: "Andy Pages",        pos: "CF", type: "batter", stats: { power: 8, hitRate: 6, contact: 6, speed: 7 } }, // 6
    ...
    pitchers: {
      startersRotation: [
        ...
        { name: "Tyler Glasnow",      type: "pitcher", stats: { role: "Starter", power: 9, velocity: 10, control: 6, technique: 8, maxStamina: 90 } },
        { name: "Walker Buehler",     type: "pitcher", stats: { role: "Starter", power: 8, velocity: 8, control: 8, technique: 8, maxStamina: 96 } },
        { name: "Roki Sasaki",        type: "pitcher", stats: { role: "Starter", power: 8, velocity: 9, control: 7, technique: 7, maxStamina: 90 } },
        { name: "Bobby Miller",       type: "pitcher", stats: { role: "Starter", power: 7, velocity: 8, control: 6, technique: 6, maxStamina: 90 } }
      ],
      reliever: { name: "Blake Treinen", type: "pitcher", stats: { role: "Reliever", power: 7, velocity: 8, control: 7, technique: 6, maxStamina: 70 } },
      closer:   { name: "Tanner Scott",  type: "pitcher", stats: { role: "Closer",  power: 9, velocity: 8, control: 7, technique: 8, maxStamina: 50 } }
    }
  }
];
